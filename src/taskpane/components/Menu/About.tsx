      ...
      <AccordionDetails>
        <Box sx={{m: 2, display: "flex", flexDirection: "column", gap: "24px"}}>
          <Typography
            ...
            gutterBottom
          >
            Make It Bilingual! helps you to create bilingual versions of your (legal) documents - in the blink
            of an eye. Save yourself hours of translation and formatting work and boost your international
            business.
          </Typography>
          <Typography
            variant="body1"
            gutterBottom
          >
            The app operates according to the highest data protection and confidentiality standards: Your data
            is processed exclusively on DSGVO-compliant servers and deleted immediately after translation. For
